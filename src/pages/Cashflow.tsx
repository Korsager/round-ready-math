...
export default function Cashflow() {
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB]">
      <NavBar />
      <header className="max-w-[1100px] mx-auto px-4 pt-8 pb-2">
        <h1 className="text-[28px] font-semibold text-[#111827]">Cashflow & Runway</h1>
        <p className="text-[14px] text-[#6B7280] mt-1">Tie revenue, costs, and your raise together. See exactly when you run out — and whether the round actually saves you.</p>
      </header>
